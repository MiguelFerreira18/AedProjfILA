...
public class Main{
    ...
    public static void main(String[] args)
    {
        ...
        gf.insereJob("Contas da universidade",5,6,200);
        System.out.println("______________________________________________ ");
        ...
        gf.insereJob("Alunos Inscritos",2,2,1);
        System.out.println("______________________________________________ ");
